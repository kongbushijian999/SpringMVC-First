...
public class BlogController {
    ...
    //此时是在addBlog.jsp页面有action="/admin/blogs/addP"
    ...
    public String addBlogPost(@ModelAttribute("blog") BlogEntity blogEntity){
        ...
        //打印博客作者
        System.out.println(blogEntity.getUserByUseId().getNickname());
        //存库
    ...
    public String updateBlogP(@ModelAttribute("blogP") BlogEntity blogEntity) {
        // 更新博客信息
        blogRepository.updateBlog(blogEntity.getTitle(), blogEntity.getUserByUseId().getId(),
